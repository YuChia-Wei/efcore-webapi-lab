...
public partial class ReadOnlySampleDbContext : DbContext
{
    public ReadOnlySampleDbContext()
    {
    }

    public ReadOnlySampleDbContext(DbContextOptions<ReadOnlySampleDbContext> options)
        : base(options)
    {
    }
